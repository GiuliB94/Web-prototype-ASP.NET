...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="gdr_Cart" runat="server" BorderStyle="Double" BorderWidth="5px" Height="195px" Width="672px" BackColor="White" BorderColor="White" CellPadding="4" GridLines="Horizontal" ShowHeaderWhenEmpty="True" EmptyDataText="No hay datos">
        <Columns>
        ...
        <HeaderStyle BackColor="#336666" BorderStyle="Solid" Font-Bold="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
